...
module.exports = function (app) {
    ...
    app.put('/updateStudent', function (req, res) {
        var id = req.body.id;
        Students.update({ id: id }, { $set: { name: req.body.name, standarad: req.body.standarad, fees: req.body.fees, date_of_joining: req.body.date_of_joining, img: req.body.img } }, function (err, result) {
            if (err) {
                console.log(err);
